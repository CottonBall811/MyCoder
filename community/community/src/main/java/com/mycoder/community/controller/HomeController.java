...
public class HomeController {
    ...
    public String getIndexPage(Model model, Page page){
        // before invoking method, SpringMVC will instantiate Model and Page automatically, and inject Page into Model
        // so, we can directly visit the data in Page object in Thymeleaf
